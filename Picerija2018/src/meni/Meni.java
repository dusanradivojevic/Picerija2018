...
public class Meni {
	 ...
	 */
	private Desert[] deserti;
	/**
	 * Niz vrsta pica u ponudi
	 */
	private Pice[] pica;
	
	Pizza p1 = new Pizza("Capricciosa","putanja",500,740,1090,"Pelat, sir, praska sunka, svez paradajz, sampinjoni, masline");
	Pizza p2 = new Pizza("Margarita","putanja",440,660,980,"Pelat, sir, parmezan, svez paradajz, masline");
	Pizza p3 = new Pizza("Serbiana","putanja",570,820,1230,"Pelat, sir , panceta, sampinjoni, pavlaka, kulen, ljute papricice");
	Pizza p4 = new Pizza("Vegeteriano","putanja",470,690,1040,"Sir, sampinjoni, masline, paradajz, rukola, paprika, crveni luk");
